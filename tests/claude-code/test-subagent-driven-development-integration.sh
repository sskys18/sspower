...
mkdir -p src test docs/sspower/plans

# Create a simple implementation plan
cat > docs/sspower/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/sspower/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from sspower directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/sspower/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"sspower:subagent-driven-development"' "$SESSION_FILE"; then
