...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/sspower
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/sspower-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using sspower:subagent-driven-development. The plan is at: $PLAN_PATH"
