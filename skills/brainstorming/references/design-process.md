...
- For appropriately-scoped projects, run the Interview benchmark (SKILL.md): score the brief, classify each gap (user-fact / repo-fact / safe-default / blocker), ask only blocker-class questions — one at a time, round cap 5. Record safe defaults for the design doc's Defaults-taken section.
