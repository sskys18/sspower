...
> **For agentic workers:** REQUIRED: Use sspower:subagent-driven-development (if subagents available) or sspower:executing-plans to implement this plan.
...
**Spec:** docs/sspower/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/sspower/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use sspower:subagent-driven-development (if subagents available) or sspower:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
