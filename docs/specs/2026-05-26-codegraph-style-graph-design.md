...
| **P5+** | One framework per phase: FastAPI → Django → Rails → NestJS → Laravel → Spring → Gin → Axum. Each ships with fixture acceptance. | per-framework precision/recall thresholds |
